"""
Django settings for leap_async_task project.
...
DEBUG = os.getenv('DEBUG', env_values.get('DEBUG'))
...
ROOT_URLCONF = 'leap_async_task.urls'
...
WSGI_APPLICATION = 'leap_async_task.wsgi.application'
